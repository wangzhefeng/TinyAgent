...
def tool_action(name: str=None, description: str=None):
    ...
    Args:
        name (str, optional): 工具名称（如果不提供，从方法名自动生成）. Defaults to None.
        description (str, optional): 工具描述（如果不提供，从 docstring 提取）. Defaults to None.
    """
...
class Tool(ABC):
    ...
    def __init__(self, name: str, description: str, expandable: bool=False):
        ...
        Args:
            ...
            expandable (bool, optional): 是否可展开为多个子工具. Defaults to False.
        """
        self.name = name
...
class AutoGeneratedTool(Tool):
    ...
    def __init__(self, parent: Tool, method: Callable, name: str=None, description: str=None):
        ...
        Args:
            ...
            name (str, optional): 工具名称（如果为 None，从方法名生成）. Defaults to None.
            description (str, optional): 工具描述（如果为 None，从 docstring 提取）. Defaults to None.
        """
        self.parent = parent
        self.method = method
    ...
    def _parse_parameters(self) -> List[ToolParameter]:
        ...
        # 从 docstring 解析参数描述
        param_descriptions = self._parse_param_description(docstring)
